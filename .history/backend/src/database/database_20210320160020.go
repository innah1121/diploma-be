...
func (model *DBModel) InsertFile(filename string,sender int,recipient int) error {
	query := fmt.Sprintf("INSERT INTO users (filename, sender_id, recipient_id) VALUES ('%s', '%i', '%i')", filename, sender, recipient)
