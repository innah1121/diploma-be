...
func handleRequests() {
	...
	myRouter.HandleFunc("/storeFile", save).Methods("POST")
...
func save(w http.ResponseWriter, r *http.Request) {
	...
	(*function.User)(nil).StoreFile(file.Filename, file.Data)
	fmt.Println("Storing file: " + file.Filename)
	fmt.Fprintf(w, "File: %+v", file)
	json.NewEncoder(w).Encode(file.Filename)
}
